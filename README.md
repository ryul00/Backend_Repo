...
|:-----------:|:--------:|:-----------------|
| FullStack   | 유광렬   | 싱글/멀티 두더지 게임, 싱글 과일 퍼즐 구현<br/>JWT 기반 브라우저 회원가입/로그인<br/>방 생성 및 초대/입장 구현, 소켓 기반 멀티플레이 로직 구현<br/>파이어베이스 구축 및 점수 저장 로직 구현<br/>프론트엔드 도메인 배포, 백엔드 서버 배포 |
