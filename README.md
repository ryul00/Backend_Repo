...
## 📝 서비스 소개
2D 웹 게임 시장에 종합 두뇌 게임이 부재하며, 기존 두뇌 게임들의 오락성, 디자인이 부족하다는 문제를 인식했고, </br>
이를 보완하여 2D웹 기반 종합 두뇌 게임 "똑똑하ZOO"를 기획하였다. </br>
싱글플레이뿐만 아니라 친구와 1vs1 멀티플레이까지 플레이 범위를 확장하여 다양성을 확보했다.
