...
|:-----------:|:--------:|:-----------------|
| FullStack   | 유광렬   | 싱글/멀티 두더지 게임, 싱글 과일 퍼즐 구현<br/>사용자 BrowerID를 활용한 JWT 기반 로그인 및 토큰 발급 기능 구현<br/>방 생성 및 초대/입장 기능, 소켓 기반 멀티플레이 로직 구현<br/>파이어베이스 구축 및 점수 저장 로직 구축<br/>깃을 활용한 버전 관리 및 깃허브 브랜치 통합<br/>프론트엔드 도메인 배포, 백엔드 서버 배포 |
